...
function inicializaMapa() {
    ...
    setMapTheme(savedDarkMode);
  
  // Aplicar classe ao body se necessário
  if (savedDarkMode) {
...
function setMapTheme(dark) {
  ...
  if (dark) {
    ...
    document.getElementById('dark-mode-toggle').classList.add('dark');
  } else {
    ...
    document.getElementById('dark-mode-toggle').classList.remove('dark');
  }
}
...
// Inicialização correta ao carregar
